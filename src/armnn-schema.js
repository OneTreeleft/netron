...
$root.armnnSerializer.ConstTensor = class ConstTensor {
    ...
    static decode(reader, position) {
        ...
        $.info = reader.table_(position, 4, $root.armnnSerializer.TensorInfo.decode);
...
$root.armnnSerializer.OutputSlot = class OutputSlot {
    ...
    static decode(reader, position) {
        ...
        $.index = reader.uint32_(position, 4, 0);
        $.tensorInfo = reader.table_(position, 6, $root.armnnSerializer.TensorInfo.decode);
        return $;
    }
};
...
$root.armnnSerializer.BindableLayerBase = class BindableLayerBase {
    ...
    static decode(reader, position) {
        ...
        $.base = reader.table_(position, 4, $root.armnnSerializer.LayerBase.decode);
...
$root.armnnSerializer.ActivationLayer = class ActivationLayer {
    ...
    static decode(reader, position) {
        ...
        $.base = reader.table_(position, 4, $root.armnnSerializer.LayerBase.decode);
        $.descriptor = reader.table_(position, 6, $root.armnnSerializer.ActivationDescriptor.decode);
        return $;
    }
};
...
$root.armnnSerializer.ArgMinMaxLayer = class ArgMinMaxLayer {
    ...
    static decode(reader, position) {
        ...
        $.base = reader.table_(position, 4, $root.armnnSerializer.LayerBase.decode);
        $.descriptor = reader.table_(position, 6, $root.armnnSerializer.ArgMinMaxDescriptor.decode);
        return $;
    }
};
...
$root.armnnSerializer.ComparisonLayer = class ComparisonLayer {
    ...
    static decode(reader, position) {
        ...
        $.base = reader.table_(position, 4, $root.armnnSerializer.LayerBase.decode);
        $.descriptor = reader.table_(position, 6, $root.armnnSerializer.ComparisonDescriptor.decode);
        return $;
    }
};
...
$root.armnnSerializer.ConstantLayer = class ConstantLayer {
    ...
    static decode(reader, position) {
        ...
        $.base = reader.table_(position, 4, $root.armnnSerializer.LayerBase.decode);
        $.input = reader.table_(position, 6, $root.armnnSerializer.ConstTensor.decode);
        return $;
    }
};
...
$root.armnnSerializer.Convolution2dLayer = class Convolution2dLayer {
    ...
    static decode(reader, position) {
        ...
        $.base = reader.table_(position, 4, $root.armnnSerializer.LayerBase.decode);
        $.descriptor = reader.table_(position, 6, $root.armnnSerializer.Convolution2dDescriptor.decode);
        $.weights = reader.table_(position, 8, $root.armnnSerializer.ConstTensor.decode);
        $.biases = reader.table_(position, 10, $root.armnnSerializer.ConstTensor.decode);
        return $;
    }
};
...
$root.armnnSerializer.DepthToSpaceLayer = class DepthToSpaceLayer {
    ...
    static decode(reader, position) {
        ...
        $.base = reader.table_(position, 4, $root.armnnSerializer.LayerBase.decode);
        $.descriptor = reader.table_(position, 6, $root.armnnSerializer.DepthToSpaceDescriptor.decode);
        return $;
    }
};
...
$root.armnnSerializer.ElementwiseUnaryLayer = class ElementwiseUnaryLayer {
    ...
    static decode(reader, position) {
        ...
        $.base = reader.table_(position, 4, $root.armnnSerializer.LayerBase.decode);
        $.descriptor = reader.table_(position, 6, $root.armnnSerializer.ElementwiseUnaryDescriptor.decode);
        return $;
    }
};
...
$root.armnnSerializer.FillLayer = class FillLayer {
    ...
    static decode(reader, position) {
        ...
        $.base = reader.table_(position, 4, $root.armnnSerializer.LayerBase.decode);
        $.descriptor = reader.table_(position, 6, $root.armnnSerializer.FillDescriptor.decode);
        return $;
    }
};
...
$root.armnnSerializer.FullyConnectedLayer = class FullyConnectedLayer {
    ...
    static decode(reader, position) {
        ...
        $.base = reader.table_(position, 4, $root.armnnSerializer.LayerBase.decode);
        $.descriptor = reader.table_(position, 6, $root.armnnSerializer.FullyConnectedDescriptor.decode);
        $.weights = reader.table_(position, 8, $root.armnnSerializer.ConstTensor.decode);
        $.biases = reader.table_(position, 10, $root.armnnSerializer.ConstTensor.decode);
        return $;
    }
...
$root.armnnSerializer.GatherLayer = class GatherLayer {
    ...
    static decode(reader, position) {
        ...
        $.base = reader.table_(position, 4, $root.armnnSerializer.LayerBase.decode);
        $.descriptor = reader.table_(position, 6, $root.armnnSerializer.GatherDescriptor.decode);
        return $;
    }
};
...
$root.armnnSerializer.InputLayer = class InputLayer {
    ...
    static decode(reader, position) {
        ...
        $.base = reader.table_(position, 4, $root.armnnSerializer.BindableLayerBase.decode);
        return $;
    }
};
...
$root.armnnSerializer.InstanceNormalizationLayer = class InstanceNormalizationLayer {
    ...
    static decode(reader, position) {
        ...
        $.base = reader.table_(position, 4, $root.armnnSerializer.LayerBase.decode);
        $.descriptor = reader.table_(position, 6, $root.armnnSerializer.InstanceNormalizationDescriptor.decode);
        return $;
    }
};
...
$root.armnnSerializer.LogSoftmaxLayer = class LogSoftmaxLayer {
    ...
    static decode(reader, position) {
        ...
        $.base = reader.table_(position, 4, $root.armnnSerializer.LayerBase.decode);
        $.descriptor = reader.table_(position, 6, $root.armnnSerializer.LogSoftmaxDescriptor.decode);
        return $;
    }
};
...
$root.armnnSerializer.L2NormalizationLayer = class L2NormalizationLayer {
    ...
    static decode(reader, position) {
        ...
        $.base = reader.table_(position, 4, $root.armnnSerializer.LayerBase.decode);
        $.descriptor = reader.table_(position, 6, $root.armnnSerializer.L2NormalizationDescriptor.decode);
        return $;
    }
};
...
$root.armnnSerializer.Pooling2dLayer = class Pooling2dLayer {
    ...
    static decode(reader, position) {
        ...
        $.base = reader.table_(position, 4, $root.armnnSerializer.LayerBase.decode);
        $.descriptor = reader.table_(position, 6, $root.armnnSerializer.Pooling2dDescriptor.decode);
        return $;
    }
};
...
$root.armnnSerializer.SoftmaxLayer = class SoftmaxLayer {
    ...
    static decode(reader, position) {
        ...
        $.base = reader.table_(position, 4, $root.armnnSerializer.LayerBase.decode);
        $.descriptor = reader.table_(position, 6, $root.armnnSerializer.SoftmaxDescriptor.decode);
        return $;
    }
};
...
$root.armnnSerializer.DepthwiseConvolution2dLayer = class DepthwiseConvolution2dLayer {
    ...
    static decode(reader, position) {
        ...
        $.base = reader.table_(position, 4, $root.armnnSerializer.LayerBase.decode);
        $.descriptor = reader.table_(position, 6, $root.armnnSerializer.DepthwiseConvolution2dDescriptor.decode);
        $.weights = reader.table_(position, 8, $root.armnnSerializer.ConstTensor.decode);
        $.biases = reader.table_(position, 10, $root.armnnSerializer.ConstTensor.decode);
        return $;
    }
...
$root.armnnSerializer.ReshapeLayer = class ReshapeLayer {
    ...
    static decode(reader, position) {
        ...
        $.base = reader.table_(position, 4, $root.armnnSerializer.LayerBase.decode);
        $.descriptor = reader.table_(position, 6, $root.armnnSerializer.ReshapeDescriptor.decode);
        return $;
    }
};
...
$root.armnnSerializer.PermuteLayer = class PermuteLayer {
    ...
    static decode(reader, position) {
        ...
        $.base = reader.table_(position, 4, $root.armnnSerializer.LayerBase.decode);
        $.descriptor = reader.table_(position, 6, $root.armnnSerializer.PermuteDescriptor.decode);
        return $;
    }
};
...
$root.armnnSerializer.SpaceToBatchNdLayer = class SpaceToBatchNdLayer {
    ...
    static decode(reader, position) {
        ...
        $.base = reader.table_(position, 4, $root.armnnSerializer.LayerBase.decode);
        $.descriptor = reader.table_(position, 6, $root.armnnSerializer.SpaceToBatchNdDescriptor.decode);
        return $;
    }
};
...
$root.armnnSerializer.SpaceToDepthLayer = class SpaceToDepthLayer {
    ...
    static decode(reader, position) {
        ...
        $.base = reader.table_(position, 4, $root.armnnSerializer.LayerBase.decode);
        $.descriptor = reader.table_(position, 6, $root.armnnSerializer.SpaceToDepthDescriptor.decode);
        return $;
    }
};
...
$root.armnnSerializer.BatchToSpaceNdLayer = class BatchToSpaceNdLayer {
    ...
    static decode(reader, position) {
        ...
        $.base = reader.table_(position, 4, $root.armnnSerializer.LayerBase.decode);
        $.descriptor = reader.table_(position, 6, $root.armnnSerializer.BatchToSpaceNdDescriptor.decode);
        return $;
    }
};
...
$root.armnnSerializer.NormalizationLayer = class NormalizationLayer {
    ...
    static decode(reader, position) {
        ...
        $.base = reader.table_(position, 4, $root.armnnSerializer.LayerBase.decode);
        $.descriptor = reader.table_(position, 6, $root.armnnSerializer.NormalizationDescriptor.decode);
        return $;
    }
};
...
$root.armnnSerializer.MeanLayer = class MeanLayer {
    ...
    static decode(reader, position) {
        ...
        $.base = reader.table_(position, 4, $root.armnnSerializer.LayerBase.decode);
        $.descriptor = reader.table_(position, 6, $root.armnnSerializer.MeanDescriptor.decode);
        return $;
    }
};
...
$root.armnnSerializer.PadLayer = class PadLayer {
    ...
    static decode(reader, position) {
        ...
        $.base = reader.table_(position, 4, $root.armnnSerializer.LayerBase.decode);
        $.descriptor = reader.table_(position, 6, $root.armnnSerializer.PadDescriptor.decode);
        return $;
    }
};
...
$root.armnnSerializer.BatchNormalizationLayer = class BatchNormalizationLayer {
    ...
    static decode(reader, position) {
        ...
        $.base = reader.table_(position, 4, $root.armnnSerializer.LayerBase.decode);
        $.descriptor = reader.table_(position, 6, $root.armnnSerializer.BatchNormalizationDescriptor.decode);
        $.mean = reader.table_(position, 8, $root.armnnSerializer.ConstTensor.decode);
        $.variance = reader.table_(position, 10, $root.armnnSerializer.ConstTensor.decode);
        $.beta = reader.table_(position, 12, $root.armnnSerializer.ConstTensor.decode);
        $.gamma = reader.table_(position, 14, $root.armnnSerializer.ConstTensor.decode);
        return $;
    }
};
...
$root.armnnSerializer.ResizeBilinearLayer = class ResizeBilinearLayer {
    ...
    static decode(reader, position) {
        ...
        $.base = reader.table_(position, 4, $root.armnnSerializer.LayerBase.decode);
        $.descriptor = reader.table_(position, 6, $root.armnnSerializer.ResizeBilinearDescriptor.decode);
        return $;
    }
};
...
$root.armnnSerializer.SliceLayer = class SliceLayer {
    ...
    static decode(reader, position) {
        ...
        $.base = reader.table_(position, 4, $root.armnnSerializer.LayerBase.decode);
        $.descriptor = reader.table_(position, 6, $root.armnnSerializer.SliceDescriptor.decode);
        return $;
    }
};
...
$root.armnnSerializer.StridedSliceLayer = class StridedSliceLayer {
    ...
    static decode(reader, position) {
        ...
        $.base = reader.table_(position, 4, $root.armnnSerializer.LayerBase.decode);
        $.descriptor = reader.table_(position, 6, $root.armnnSerializer.StridedSliceDescriptor.decode);
        return $;
    }
};
...
$root.armnnSerializer.ConcatLayer = class ConcatLayer {
    ...
    static decode(reader, position) {
        ...
        $.base = reader.table_(position, 4, $root.armnnSerializer.LayerBase.decode);
        $.descriptor = reader.table_(position, 6, $root.armnnSerializer.OriginsDescriptor.decode);
        return $;
    }
};
...
$root.armnnSerializer.ViewsDescriptor = class ViewsDescriptor {
    ...
    static decode(reader, position) {
        ...
        $.origins = reader.table_(position, 4, $root.armnnSerializer.OriginsDescriptor.decode);
...
$root.armnnSerializer.SplitterLayer = class SplitterLayer {
    ...
    static decode(reader, position) {
        ...
        $.base = reader.table_(position, 4, $root.armnnSerializer.LayerBase.decode);
        $.descriptor = reader.table_(position, 6, $root.armnnSerializer.ViewsDescriptor.decode);
        return $;
    }
};
...
$root.armnnSerializer.DetectionPostProcessLayer = class DetectionPostProcessLayer {
    ...
    static decode(reader, position) {
        ...
        $.base = reader.table_(position, 4, $root.armnnSerializer.LayerBase.decode);
        $.descriptor = reader.table_(position, 6, $root.armnnSerializer.DetectionPostProcessDescriptor.decode);
        $.anchors = reader.table_(position, 8, $root.armnnSerializer.ConstTensor.decode);
        return $;
    }
};
...
$root.armnnSerializer.LstmInputParams = class LstmInputParams {
    ...
    static decode(reader, position) {
        ...
        $.inputToForgetWeights = reader.table_(position, 4, $root.armnnSerializer.ConstTensor.decode);
        $.inputToCellWeights = reader.table_(position, 6, $root.armnnSerializer.ConstTensor.decode);
        $.inputToOutputWeights = reader.table_(position, 8, $root.armnnSerializer.ConstTensor.decode);
        $.recurrentToForgetWeights = reader.table_(position, 10, $root.armnnSerializer.ConstTensor.decode);
        $.recurrentToCellWeights = reader.table_(position, 12, $root.armnnSerializer.ConstTensor.decode);
        $.recurrentToOutputWeights = reader.table_(position, 14, $root.armnnSerializer.ConstTensor.decode);
        $.forgetGateBias = reader.table_(position, 16, $root.armnnSerializer.ConstTensor.decode);
        $.cellBias = reader.table_(position, 18, $root.armnnSerializer.ConstTensor.decode);
        $.outputGateBias = reader.table_(position, 20, $root.armnnSerializer.ConstTensor.decode);
        $.inputToInputWeights = reader.table_(position, 22, $root.armnnSerializer.ConstTensor.decode);
        $.recurrentToInputWeights = reader.table_(position, 24, $root.armnnSerializer.ConstTensor.decode);
        $.cellToInputWeights = reader.table_(position, 26, $root.armnnSerializer.ConstTensor.decode);
        $.inputGateBias = reader.table_(position, 28, $root.armnnSerializer.ConstTensor.decode);
        $.projectionWeights = reader.table_(position, 30, $root.armnnSerializer.ConstTensor.decode);
        $.projectionBias = reader.table_(position, 32, $root.armnnSerializer.ConstTensor.decode);
        $.cellToForgetWeights = reader.table_(position, 34, $root.armnnSerializer.ConstTensor.decode);
        $.cellToOutputWeights = reader.table_(position, 36, $root.armnnSerializer.ConstTensor.decode);
        $.inputLayerNormWeights = reader.table_(position, 38, $root.armnnSerializer.ConstTensor.decode);
        $.forgetLayerNormWeights = reader.table_(position, 40, $root.armnnSerializer.ConstTensor.decode);
        $.cellLayerNormWeights = reader.table_(position, 42, $root.armnnSerializer.ConstTensor.decode);
        $.outputLayerNormWeights = reader.table_(position, 44, $root.armnnSerializer.ConstTensor.decode);
        return $;
    }
};
...
$root.armnnSerializer.LstmLayer = class LstmLayer {
    ...
    static decode(reader, position) {
        ...
        $.base = reader.table_(position, 4, $root.armnnSerializer.LayerBase.decode);
        $.descriptor = reader.table_(position, 6, $root.armnnSerializer.LstmDescriptor.decode);
        $.inputParams = reader.table_(position, 8, $root.armnnSerializer.LstmInputParams.decode);
        return $;
    }
};
...
$root.armnnSerializer.QLstmInputParams = class QLstmInputParams {
    ...
    static decode(reader, position) {
        ...
        $.inputToInputWeights = reader.table_(position, 22, $root.armnnSerializer.ConstTensor.decode);
        $.recurrentToInputWeights = reader.table_(position, 24, $root.armnnSerializer.ConstTensor.decode);
        $.inputGateBias = reader.table_(position, 26, $root.armnnSerializer.ConstTensor.decode);
        $.projectionWeights = reader.table_(position, 28, $root.armnnSerializer.ConstTensor.decode);
        $.projectionBias = reader.table_(position, 30, $root.armnnSerializer.ConstTensor.decode);
        $.cellToInputWeights = reader.table_(position, 32, $root.armnnSerializer.ConstTensor.decode);
        $.cellToForgetWeights = reader.table_(position, 34, $root.armnnSerializer.ConstTensor.decode);
        $.cellToOutputWeights = reader.table_(position, 36, $root.armnnSerializer.ConstTensor.decode);
        $.inputLayerNormWeights = reader.table_(position, 38, $root.armnnSerializer.ConstTensor.decode);
        $.forgetLayerNormWeights = reader.table_(position, 40, $root.armnnSerializer.ConstTensor.decode);
...
$root.armnnSerializer.QLstmLayer = class QLstmLayer {
    ...
    static decode(reader, position) {
        ...
        $.base = reader.table_(position, 4, $root.armnnSerializer.LayerBase.decode);
        $.descriptor = reader.table_(position, 6, $root.armnnSerializer.QLstmDescriptor.decode);
        $.inputParams = reader.table_(position, 8, $root.armnnSerializer.QLstmInputParams.decode);
        return $;
    }
};
...
$root.armnnSerializer.QuantizedLstmInputParams = class QuantizedLstmInputParams {
    ...
    static decode(reader, position) {
        ...
        $.inputToInputWeights = reader.table_(position, 4, $root.armnnSerializer.ConstTensor.decode);
        $.inputToForgetWeights = reader.table_(position, 6, $root.armnnSerializer.ConstTensor.decode);
        $.inputToCellWeights = reader.table_(position, 8, $root.armnnSerializer.ConstTensor.decode);
        $.inputToOutputWeights = reader.table_(position, 10, $root.armnnSerializer.ConstTensor.decode);
        $.recurrentToInputWeights = reader.table_(position, 12, $root.armnnSerializer.ConstTensor.decode);
        $.recurrentToForgetWeights = reader.table_(position, 14, $root.armnnSerializer.ConstTensor.decode);
        $.recurrentToCellWeights = reader.table_(position, 16, $root.armnnSerializer.ConstTensor.decode);
        $.recurrentToOutputWeights = reader.table_(position, 18, $root.armnnSerializer.ConstTensor.decode);
        $.inputGateBias = reader.table_(position, 20, $root.armnnSerializer.ConstTensor.decode);
        $.forgetGateBias = reader.table_(position, 22, $root.armnnSerializer.ConstTensor.decode);
        $.cellBias = reader.table_(position, 24, $root.armnnSerializer.ConstTensor.decode);
        $.outputGateBias = reader.table_(position, 26, $root.armnnSerializer.ConstTensor.decode);
        return $;
    }
};
...
$root.armnnSerializer.QuantizedLstmLayer = class QuantizedLstmLayer {
    ...
    static decode(reader, position) {
        ...
        $.base = reader.table_(position, 4, $root.armnnSerializer.LayerBase.decode);
        $.inputParams = reader.table_(position, 6, $root.armnnSerializer.QuantizedLstmInputParams.decode);
        return $;
    }
};
...
$root.armnnSerializer.TransposeConvolution2dLayer = class TransposeConvolution2dLayer {
    ...
    static decode(reader, position) {
        ...
        $.base = reader.table_(position, 4, $root.armnnSerializer.LayerBase.decode);
        $.descriptor = reader.table_(position, 6, $root.armnnSerializer.TransposeConvolution2dDescriptor.decode);
        $.weights = reader.table_(position, 8, $root.armnnSerializer.ConstTensor.decode);
        $.biases = reader.table_(position, 10, $root.armnnSerializer.ConstTensor.decode);
        return $;
    }
...
$root.armnnSerializer.TransposeLayer = class TransposeLayer {
    ...
    static decode(reader, position) {
        ...
        $.base = reader.table_(position, 4, $root.armnnSerializer.LayerBase.decode);
        $.descriptor = reader.table_(position, 6, $root.armnnSerializer.TransposeDescriptor.decode);
        return $;
    }
};
...
$root.armnnSerializer.ResizeLayer = class ResizeLayer {
    ...
    static decode(reader, position) {
        ...
        $.base = reader.table_(position, 4, $root.armnnSerializer.LayerBase.decode);
        $.descriptor = reader.table_(position, 6, $root.armnnSerializer.ResizeDescriptor.decode);
        return $;
    }
};
...
$root.armnnSerializer.StackLayer = class StackLayer {
    ...
    static decode(reader, position) {
        ...
        $.base = reader.table_(position, 4, $root.armnnSerializer.LayerBase.decode);
        $.descriptor = reader.table_(position, 6, $root.armnnSerializer.StackDescriptor.decode);
        return $;
    }
};
...
$root.armnnSerializer.StandInLayer = class StandInLayer {
    ...
    static decode(reader, position) {
        ...
        $.base = reader.table_(position, 4, $root.armnnSerializer.LayerBase.decode);
        $.descriptor = reader.table_(position, 6, $root.armnnSerializer.StandInDescriptor.decode);
        return $;
    }
};
...
$root.armnnSerializer.SerializedGraph = class SerializedGraph {
    ...
    static create(reader) {
        return $root.armnnSerializer.SerializedGraph.decode(reader, reader.int32(reader.position) + reader.position);
    }
    ...
    static decode(reader, position) {
        ...
        $.featureVersions = reader.table_(position, 10, $root.armnnSerializer.FeatureCompatibilityVersions.decode);
        return $;
    }
};
