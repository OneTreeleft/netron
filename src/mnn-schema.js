...
$root.MNN.TensorDescribe = class TensorDescribe {
    ...
    static decode(reader, position) {
        ...
        $.blob = reader.table_(position, 4, $root.MNN.Blob.decode);
...
$root.MNN.Net = class Net {
    ...
    static create(reader) {
        return $root.MNN.Net.decode(reader, reader.int32(reader.position) + reader.position);
    }
    ...
    static decode(reader, position) {
        ...
        $.gpulibrary = reader.table_(position, 8, $root.MNN.GpuLibrary.decode);
...
$root.MNN.Convolution2D = class Convolution2D {
    ...
    static decode(reader, position) {
        ...
        $.common = reader.table_(position, 4, $root.MNN.Convolution2DCommon.decode);
        $.weight = reader.array(position, 6, Float32Array);
        $.bias = reader.array(position, 8, Float32Array);
        $.quanParameter = reader.table_(position, 10, $root.MNN.IDSTQuan.decode);
        $.symmetricQuan = reader.table_(position, 12, $root.MNN.QuantizedFloatParam.decode);
        return $;
    }
};
...
$root.MNN.Convolution3D = class Convolution3D {
    ...
    static decode(reader, position) {
        ...
        $.common = reader.table_(position, 4, $root.MNN.Convolution3DCommon.decode);
        $.weight = reader.array(position, 6, Float32Array);
        $.bias = reader.array(position, 8, Float32Array);
        return $;
    }
...
$root.MNN.InnerProduct = class InnerProduct {
    ...
    static decode(reader, position) {
        ...
        $.quanParameter = reader.table_(position, 18, $root.MNN.IDSTQuan.decode);
        return $;
    }
};
...
$root.MNN.LSTM = class LSTM {
    ...
    static decode(reader, position) {
        ...
        $.weightI = reader.table_(position, 10, $root.MNN.Blob.decode);
        $.weightH = reader.table_(position, 12, $root.MNN.Blob.decode);
        $.bias = reader.table_(position, 14, $root.MNN.Blob.decode);
        $.weightIQ = reader.table_(position, 16, $root.MNN.Blob.decode);
        $.weightIA = reader.table_(position, 18, $root.MNN.Blob.decode);
...
$root.MNN.Proposal = class Proposal {
    ...
    static decode(reader, position) {
        ...
        $.ratios = reader.table_(position, 16, $root.MNN.Blob.decode);
        $.scales = reader.table_(position, 18, $root.MNN.Blob.decode);
        $.anchors = reader.table_(position, 20, $root.MNN.Blob.decode);
        return $;
    }
};
...
$root.MNN.EltwiseInt8 = class EltwiseInt8 {
    ...
    static decode(reader, position) {
        ...
        $.type = reader.int8_(position, 4, 0);
        $.inputQuan0 = reader.table_(position, 6, $root.MNN.QuantizedFloatParam.decode);
        $.inputQuan1 = reader.table_(position, 8, $root.MNN.QuantizedFloatParam.decode);
        $.outputQuan = reader.table_(position, 10, $root.MNN.QuantizedFloatParam.decode);
        return $;
    }
};
...
$root.MNN.Attribute = class Attribute {
    ...
    static decode(reader, position) {
        ...
        $.tensor = reader.table_(position, 16, $root.MNN.Blob.decode);
        $.list = reader.table_(position, 18, $root.MNN.ListValue.decode);
        return $;
    }
};
...
$root.MNN.SpaceBatch = class SpaceBatch {
    ...
    static decode(reader, position) {
        ...
        $.blockShape = reader.table_(position, 4, $root.MNN.Blob.decode);
        $.padding = reader.table_(position, 6, $root.MNN.Blob.decode);
        return $;
    }
};
...
$root.MNN.RNNParam = class RNNParam {
    ...
    static decode(reader, position) {
        ...
        $.fwGateWeight = reader.table_(position, 10, $root.MNN.Blob.decode);
        $.fwGateBias = reader.table_(position, 12, $root.MNN.Blob.decode);
        $.fwCandidateWeight = reader.table_(position, 14, $root.MNN.Blob.decode);
        $.fwCandidateBias = reader.table_(position, 16, $root.MNN.Blob.decode);
        $.bwGateWeight = reader.table_(position, 18, $root.MNN.Blob.decode);
        $.bwGateBias = reader.table_(position, 20, $root.MNN.Blob.decode);
        $.bwCandidateWeight = reader.table_(position, 22, $root.MNN.Blob.decode);
        $.bwCandidateBias = reader.table_(position, 24, $root.MNN.Blob.decode);
        return $;
    }
};
...
$root.MNN.QuantizedAdd = class QuantizedAdd {
    ...
    static decode(reader, position) {
        ...
        $.input1QuantizedParam = reader.table_(position, 6, $root.MNN.QuantizedParam.decode);
        $.input2QuantizedParam = reader.table_(position, 8, $root.MNN.QuantizedParam.decode);
        $.outputQuantizedParam = reader.table_(position, 10, $root.MNN.QuantizedParam.decode);
        return $;
    }
};
...
$root.MNN.Dequantize = class Dequantize {
    ...
    static decode(reader, position) {
        ...
        $.inputQuantizedParam = reader.table_(position, 4, $root.MNN.QuantizedParam.decode);
...
$root.MNN.QuantizedConcat = class QuantizedConcat {
    ...
    static decode(reader, position) {
        ...
        $.outputQuantizedParam = reader.table_(position, 12, $root.MNN.QuantizedParam.decode);
        return $;
    }
};
...
$root.MNN.QuantizedLogistic = class QuantizedLogistic {
    ...
    static decode(reader, position) {
        ...
        $.inputQuantizedParam = reader.table_(position, 4, $root.MNN.QuantizedParam.decode);
        $.outputQuantizedParam = reader.table_(position, 6, $root.MNN.QuantizedParam.decode);
        return $;
    }
};
...
$root.MNN.TfQuantizedConv2D = class TfQuantizedConv2D {
    ...
    static decode(reader, position) {
        ...
        $.common = reader.table_(position, 8, $root.MNN.Convolution2DCommon.decode);
        ...
        $.biasQuantizedParam = reader.table_(position, 22, $root.MNN.QuantizedParam.decode);
        $.depthMultiplier = reader.int32_(position, 24, 0);
        $.filterQuantizedParam = reader.table_(position, 26, $root.MNN.QuantizedParam.decode);
        $.inputQuantizedParam = reader.table_(position, 28, $root.MNN.QuantizedParam.decode);
        $.modelFormat = reader.int8_(position, 30, 0);
        $.outputQuantizedParam = reader.table_(position, 32, $root.MNN.QuantizedParam.decode);
        return $;
    }
};
...
$root.MNN.GpuBuffer = class GpuBuffer {
    ...
    static decode(reader, position) {
        ...
        $.content = reader.table_(position, 8, $root.MNN.Blob.decode);
        return $;
    }
};
